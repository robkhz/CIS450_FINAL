...
esp_err_t audio_handle_info(PDM_SOUND_TYPE voice)
{
    ...
    case SOUND_TYPE_FACTORY:
        ...
        break;
    case SOUND_TYPE_LIGHT_LEVEL_0:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "brightness0.mp3");
        break;
    case SOUND_TYPE_LIGHT_LEVEL_25:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "brightness25.mp3");
        break;
    case SOUND_TYPE_LIGHT_LEVEL_50:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "brightness50.mp3");
        break;
    case SOUND_TYPE_LIGHT_LEVEL_75:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "brightness75.mp3");
        break;
    case SOUND_TYPE_LIGHT_LEVEL_100:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "brightness100.mp3");
        break;
    }
